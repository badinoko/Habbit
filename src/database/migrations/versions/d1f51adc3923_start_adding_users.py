...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_habits_owner_id_users', 'habits', 'users', ['owner_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key('fk_themes_owner_id_users', 'themes', 'users', ['owner_id'], ['id'], ondelete='CASCADE')
