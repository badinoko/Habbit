...
| HF-014 | ACTIVE | Define redesign v2 typography and navbar direction | Unified direction now lives in `docs/reviews/v2-direction.md`; implementation wave should follow its type-role, navbar-density, and stats-IA decisions |
